...
class spawning():
    '''
        Used to determine with what weight a certain route is chosen.
        spawning is not constant over time because it resembles our dataset.
    '''
...
class const_spawning():
    '''
        Due to changes in how the vehicle generator runs, even constant values
        for the weights need to be packed into constants of a class-object.
    '''

    def __init__(self, *args):
        '''
        This function is used if the weights for all eight destinations are
        constant over time.

        Parameters
        ----------
        *args : Tuple
            Tuple of size 8 which conatins weights for all 8 routes.
