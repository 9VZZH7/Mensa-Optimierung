...
def run(steps=100, v_max=16.6, v_rate='variable', v_weight='variable',
    ...
    sim.create_gen({
        ...
        'v_max': v_max,
        'vehicles': [
            [weights.essen_1, {'path': [0, 1, 2, *road(35), 3, 4, 6, 9, 10]}],
            [weights.essen_2, {'path': [0, 1, 2, *road(35 + n), 3, 5, 8, 9, 10]}],
            [weights.essen_3_west, {'path': [0, 1, 2, *road(35 + n), 6, 7, *road(35 + 2 * n), 10]}],
            [weights.essen_3_ost, {'path': [0, 1, 2, *road(35 + n), 5, 7, 11, 12, 22]}],
            [weights.essen_6, {'path': [13, 14, 15, *road(35 + 3 * n), 16, 17, 19, 22, 23]}],
            [weights.essen_5, {'path': [13, 14, 15, *road(35 + 4 * n), 16, 18, 21, 22, 23]}],
            [weights.essen_4_ost, {'path': [13, 14, 15, *road(35 + 4 * n), 19, 20, *road(35 + 5 * n), 23]}],
            [weights.essen_4_west, {'path': [13, 14, 15, *road(35 + 4 * n), 19, 20, 24, 25, 10]}],
        ]
    })
